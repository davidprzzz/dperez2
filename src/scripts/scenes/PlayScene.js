...
class PlayScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.ground = this.add.tileSprite(0, height, 100, 20, 'ground').setOrigin(0, 1);
    ...
    this.highScoreText = this.add.text(0, 0, "00000", {fill: "#FFFFFF", font: '900 35px Courier', resolution: 5})
      .setOrigin(1, 0)
      .setAlpha(0);
      ...
      this.text.addMultiple([          
          this.add.image(600, 120,'name'),
          this.add.image(300, 120,'profile'),
          this.add.image(900, 120,'kings'),
          this.add.image(1200, 180, 'wharton')
      ]);
    ...
    this.cameras.main.setBackgroundColor("#2f1fe0");
    this.initAnims();
    this.handleInputs();
  ...
  update(time, delta) {
    ...
    Phaser.Actions.IncX(this.text.getChildren(), -0.8);
    ...
    this.text.getChildren().forEach(env => {
